...
import { columnsClientActive } from "./column-active-table";
...
export function ClientsActiveTable({
  ...
  data: z.infer<typeof clientActiveSchema>[];
  table: TanstackTable<z.infer<typeof clientActiveSchema>>;
}) {
          ...
          <Table>
            ...
            <TableBody className="**:data-[slot=table-cell]:first:w-8">
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  <TableCell
                    colSpan={columnsClientActive.length}
