    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="font-medium">{getCycleLabel(subscription.billingCycle)}</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <CreditCard className="h-4 w-4 text-muted-foreground" />
                ...
                <span className="font-medium">
                  {formatCurrency(
                    subscription.billingCycle === "monthly" 
                      ...
                      : currentPlan.priceYearly || currentPlan.priceMonthly * 10
          ...
          <CardFooter className="flex gap-3 border-t pt-6">
            <Button onClick={onOpenChangePlan}>
              Cambiar plan
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {Object.entries(currentPlanWithFeatures.features).map(([key, enabled]) => (
      ...
      <div className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            {Object.entries(currentPlanWithFeatures.limits).map(([key, limit]) => {
              if (limit === 0) return null;
              
              const current = currentUsage[key as keyof typeof currentUsage] || 0;
              ...
              return (
                <div key={key} className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">{limitLabels[key]}</span>
                    <span className="font-medium">
            ...
            {Object.values(currentPlanWithFeatures.limits).every(l => l === -1) && (
