...
import { columnsRentalsPending } from "./column-pending-table";
import { rentalsPendingSchema } from "../type/type.pending";

export function RentalsPendingTable({
  data: initialData,
  table,
}: {
  data: z.infer<typeof rentalsPendingSchema>[];
  table: TanstackTable<z.infer<typeof rentalsPendingSchema>>;
}) {
          ...
          <Table>
            ...
            <TableBody className="**:data-[slot=table-cell]:first:w-8">
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  <TableCell
                    colSpan={columnsRentalsPending.length}
