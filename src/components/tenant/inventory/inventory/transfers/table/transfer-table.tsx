              ...
              {paginatedTransfers.map((transfer) => {
                ...
                return (
                  <TableRow key={transfer.id}>
                    ...
                    <TableCell>
                      <Badge className={cn(PRIORITY_COLORS[transfer.priority])}>
                        {transfer.priority}
                      </Badge>
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        {transfer.requiresApproval && !transfer.approvedBy && (
                        ...
                        <DialogContent className="max-w-2xl">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              {transfer.status === "pendiente" && onCancel && (
                                <Button
                                  variant="destructive"
      ...
      <div className="flex items-center justify-between px-4 py-4">
        <div className="flex w-full items-center justify-end gap-8 lg:w-fit lg:ml-auto">
          <div className="hidden items-center gap-2 lg:flex">
            <Label
              htmlFor="rows-per-page-transfer"
