...
import { DraggableRowRefund } from "./dragrable-row-refund";
import { columnsPaymentRefund } from "./column-refund-table";

export function PaymentRefundTable({
  data: initialData,
  table,
}: {
              ...
              {table.getRowModel().rows?.length ? (
                ...
                >
                  {table.getRowModel().rows.map((row) => (
                    <DraggableRowRefund key={row.id} row={row} />
                  ))}
                </SortableContext>
              ) : (
                <TableRow>
                  <TableCell
                    colSpan={columnsPaymentRefund.length}
