...
import { DraggableRowCanceled } from "./dragrable-row-canceled";
import { columnsPaymentCanceled } from "./column-canceled-table";

export function PaymentCanceledTable({
  data: initialData,
  table,
}: {
              ...
              {table.getRowModel().rows?.length ? (
                ...
                >
                  {table.getRowModel().rows.map((row) => (
                    <DraggableRowCanceled key={row.id} row={row} />
                  ))}
                </SortableContext>
              ) : (
                <TableRow>
                  <TableCell
                    colSpan={columnsPaymentCanceled.length}
