...
import { DraggableRowCompleted } from "./dragrable-row-completed";
import { columnsPaymentCompleted } from "./column-completed-table";

export function PaymentCompletedTable({
  data: initialData,
  table,
}: {
              ...
              {table.getRowModel().rows?.length ? (
                ...
                >
                  {table.getRowModel().rows.map((row) => (
                    <DraggableRowCompleted key={row.id} row={row} />
                  ))}
                </SortableContext>
              ) : (
                <TableRow>
                  <TableCell
                    colSpan={columnsPaymentCompleted.length}
