...
import { ArrowLeft, Check, X, Edit, Save } from "lucide-react";
...
interface PlanDetailsTabsProps {
  plan: Plan & { features?: any[]; limits?: any[] };
  onBack: () => void;
  tenants: any[];
  subscriptions: any[];
}
...
export const PlanDetailsTabs: React.FC<PlanDetailsTabsProps> = ({
  ...
  const [editedFeatures, setEditedFeatures] = useState<Set<PlanFeatureKey>>(
    new Set(),
  );
  ...
  useEffect(() => {
    ...
    setEditedFeatures(new Set(planFeatures as PlanFeatureKey[]));
  ...
  const tenantsUsingPlan = subscriptions
                  ...
                  return (
                    ...
                    >
                      {isEditing ? (
                        ...
                        <div
                          className={`p-1 rounded-full ${hasFeature ? "bg-green-100" : "bg-gray-100"}`}
                        >
                          {hasFeature ? (
                    ...
                    <div key={limitKey} className="space-y-2">
                      ...
                      {isEditing ? (
                        <Input
                          ...
                          onChange={(e) =>
                            updateLimit(limitKey, e.target.value)
                          }
                        ...
                        <div className="flex items-center space-x-2">
                          <div className="flex-1 h-2 bg-secondary rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${Math.min((limit / 100) * 100, 100)}%`,
                              }}
                            />
                          </div>
        ...
        <TabsContent value="tenants">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {tenantsUsingPlan.length} tenants tienen suscripciones activas
                en este plan
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <div>
              ...
              {isEditing ? (
                <Input
                  ...
                  onChange={(e) =>
                    handlePlanChange("priceMonthly", parseFloat(e.target.value))
                  }
                  className="mt-1"
                />
              ) : (
            ...
            <div>
              ...
              {isEditing ? (
                <Input
                  ...
                  onChange={(e) =>
                    handlePlanChange("priceYearly", parseFloat(e.target.value))
                  }
                  className="mt-1"
                />
              ) : (
            ...
            <div>
              ...
              {isEditing ? (
                <Input
                  ...
                  onChange={(e) =>
                    handlePlanChange("trialDays", parseInt(e.target.value))
                  }
                  className="mt-1"
                />
              ) : (
            ...
            <div>
              ...
              {isEditing ? (
                <Input
                  ...
                  onChange={(e) =>
                    handlePlanChange("sortOrder", parseInt(e.target.value))
                  }
                  className="mt-1"
                />
              ) : (
