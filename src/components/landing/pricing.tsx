...
export function Pricing() {
  ...
  const activePlans = plans.filter(
    (plan) => plan.modules.mode === activeModule,
  );

  return (
    <section
      id="pricing"
      className="container mx-auto px-4 py-24 bg-slate-50 dark:bg-slate-900/20 rounded-3xl my-12"
    >
      <div className="text-center space-y-4 mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Elige el módulo que mejor se adapte a tu negocio. Paga solo por lo que
          necesitas.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-12">
        ...
        >
          <CardHeader className="p-4 flex flex-row items-center gap-4 space-y-0">
            <div
              className={`p-2 rounded-lg ${activeModule === "all" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
            >
        ...
        >
          <CardHeader className="p-4 flex flex-row items-center gap-4 space-y-0">
            <div
              className={`p-2 rounded-lg ${activeModule === "rentals_only" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
            >
        ...
        >
          <CardHeader className="p-4 flex flex-row items-center gap-4 space-y-0">
            <div
              className={`p-2 rounded-lg ${activeModule === "sales_only" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
            >
              ...
              return (
                <Card
                  ...
                  className={`relative flex flex-col transition-all duration-300 hover:shadow-xl ${
                    isPopular
                      ? "border-2 border-primary shadow-lg sticky scale-105 z-10"
                      : ""
                  }`}
                >
                  {isPopular && (
                  ...
                  <CardHeader className=" pt-2">
                    ...
                    <CardDescription className="mt-2 h-12 text-sm">
                      {plan.description}
                    </CardDescription>
                  </CardHeader>
